...
SECRET_KEY = 'django-insecure-w=0*z1n!tr0p(_(di5qsqy98*7(o12_e-ub0ga)-87#*-td7rs'
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware', # este corsheaders segun la documentacion debe ir antes de CommonMiddleware
